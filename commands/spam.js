module.exports = {
	...
	execute(client, message, args) {
        ...
        if (spam_channel) {
            ...
            if(spam_no > 99) return message.channel.send("Can't spam more than 99 message in once").then(m => {m.delete(4000)});            for(var i=0; i <spam_no; i++) spam_channel.send(spam_message);
        }
        else {
